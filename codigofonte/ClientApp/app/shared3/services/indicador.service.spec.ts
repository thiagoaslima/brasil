...
import { IndicadorService3 } from './indicador.service';
...
describe('IndicadorService', () => {
    ...
    const indicadoresPesquisa_Arvore = [
    ...
    describe('getIndicadoresdaPesquisa()', () => {
        ...
        describe('com escopo filhos e sem Pesquisa', () => {
            const pesquisaId = 13;
            const mockResponse = new Response(new ResponseOptions({ body: indicadoresPesquisa, status: 200 }));
            ...
            it('deve retornar 3 indicadores', fakeAsync(
                inject([IndicadorService3, MockBackend], (indicadorService: IndicadorService3, mockBackend: MockBackend) => {
                    ...
                    indicadorService.getIndicadoresDaPesquisa(pesquisaId).subscribe(indicadores => serviceResponse = indicadores)
            ...
            it('os indicadores devem ter a id da pesquisa a qual pertencem', fakeAsync(
                inject([IndicadorService3, MockBackend], (indicadorService: IndicadorService3, mockBackend: MockBackend) => {
                    ...
                    expect(serviceResponse.length).toBe(3)
                    expect(serviceResponse[0].pesquisaId).toBe(pesquisaId)
                    expect(serviceResponse[1].pesquisaId).toBe(pesquisaId)
                    expect(serviceResponse[2].pesquisaId).toBe(pesquisaId)
                })
            ))
        ...
        xdescribe('com escopo arvoreCompleta e sem Pesquisa', () => {
