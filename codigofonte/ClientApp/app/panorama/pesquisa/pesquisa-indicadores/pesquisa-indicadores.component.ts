import { Component, OnChanges, Input, EventEmitter, Output, Inject, PLATFORM_ID } from '@angular/core';
...
export class PesquisaIndicadoresComponent implements OnChanges {
    ...
    constructor(
        ...
        private _localidade:LocalidadeService3,
    ...
    ngOnChanges() {
        if(this.pesquisa && this.localidades && this.localidades.length > 0){
            ...
            let subscription$$ = this._sintese.getPesquisaLocalidades(this.pesquisa['id'], this.localidades[0], this.localidades[1], this.localidades[2], this.posicaoIndicador, escopoIndicadores.arvoreCompleta).subscribe((indicadores) => {
